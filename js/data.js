...
const PROJECTS_DATA = [
...

    {
        ...
        imageHero: "image/projets/volatiles/vue1.webp",
        gallery: [
            { src: "image/projets/volatiles/store.webp", layout: "portrait col-span-2" },
            { src: "image/projets/volatiles/croquis-2.webp", layout: "landscape col-span-3" },
            { src: "image/projets/volatiles/noel.webp", layout: "landscape col-span-3" },
            { src: "image/projets/volatiles/grav.mp4", layout: "portrait col-span-2" }, // Votre vidéo verticale
            { src: "image/projets/volatiles/2025-giro-mains-cave-large.png", layout: "portrait col-span-3" },
            { src: "image/projets/volatiles/volatiles0.webp", layout: "square col-span-2" }
        ]
    },
...

    {
        ...
        gallery: [
            { src: "image/projets/perso/client-illu(4).webp", layout: "portrait" }
        ]
    },

    {
        ...
        gallery: [
            ...
            { src: "image/projets/archi/archi3.webp", layout: "portrait" },
            { src: "image/projets/archi/perso-archi(2).webp", layout: "landscape" }
